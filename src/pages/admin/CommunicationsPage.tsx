...
const statusStyles: Record<string, { bg: string; text: string; icon: string }> = {
  ...
  skipped: { bg: 'bg-gray-100', text: 'text-gray-500', icon: '×' },
  queued: { bg: 'bg-amber-50', text: 'text-amber-700', icon: '•' },
};
        ...
        <div className="space-y-2">
          {filtered.map(log => {
            ...
            return (
              <div
                key={log.id}
                className="bg-white border border-gray-200/70 rounded-2xl px-4 py-3 flex items-start gap-3 hover:border-gray-300 transition-colors"
              >
