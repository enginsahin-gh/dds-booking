...
// Bottom nav: only show 5 most important items on mobile
const bottomNavItems = [0, 1, 2, 3, 5]; // dashboard, bookings, customers, services, payments
