...
function SubscriptionTab({
  salon, showPlanSelect, setShowPlanSelect, selectedPlan, setSelectedPlan,
  activating, setActivating, showCancelModal, setShowCancelModal,
  cancelling, setCancelling, addToast,
}: {
  salon: Salon;
  showPlanSelect: boolean;
  setShowPlanSelect: (v: boolean) => void;
  ...
  const status = salon.subscription_status || 'none';
      ...
      <div className="mt-5 max-w-2xl">
        ...
        <TabPanel active={activeTab === 'subscription'}>
          <SubscriptionTab
            ...
            setShowPlanSelect={setShowPlanSelect}
